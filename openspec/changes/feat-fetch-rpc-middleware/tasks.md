...
- [x] 3.3 Assemble chains after plugin initialization in `RenderContext.__init__`: wrap `FETCH_PORT_KEY` (and resolve RPC registry wrapping) only when middlewares are non-empty; re-provide keys
