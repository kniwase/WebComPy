...
- [x] **Task 1: Add `wasm_serving` to AppConfig**
...
- [x] **Task 2: Implement WASM wheel download with caching**
...
- [x] **Task 3: Update lock file for `wasm_serving`**
...
- [x] **Task 4: Update `generate_html()` for local WASM URLs**
...
- [x] **Task 5: Update server and SSG for WASM local serving**
