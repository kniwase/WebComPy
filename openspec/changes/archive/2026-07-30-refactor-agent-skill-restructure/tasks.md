...
- [x] 6.3 After merge, watch the first AI Code Review job run to confirm skill loading (or Read-fallback) works in the headless environment and the review comment posts with full Action Items
