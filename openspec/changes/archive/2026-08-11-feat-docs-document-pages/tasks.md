...
- [x] 2.3 Create `docs_app/components/docs_page.py`: `docs_page_template(doc, current_path)` rendering `<article class="prose">` + TOC aside (absolute-path fragment links `<a href="{current_path}#{id}">`, hidden when toc empty)
