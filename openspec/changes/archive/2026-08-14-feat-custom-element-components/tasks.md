...
- [x] 8.4 Add public documentation and examples for named components, multiple roots, lifecycle hooks, observed attributes, and `:host`.
- [x] 8.5 Update `AGENTS.md` and `.opencode/skills/webcompy-review/SKILL.md` spec mappings/invariants for the new capability, then run the documentation reference guardrail.
- [x] 8.6 Run the relevant OpenSpec validation, formatter/linter, type checker, unit tests, and targeted E2E groups; record any unresolved bridge-runtime limitation.
