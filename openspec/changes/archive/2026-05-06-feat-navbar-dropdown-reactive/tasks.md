- [x] **Task 1**: Remove Bootstrap JS dependency from docs_app
...
- [x] **Task 2**: Rewrite `docs_app/components/navigation.py` with reactive dropdown
...
- [x] **Task 3**: Implement mobile responsive hamburger menu
...
- [x] **Task 4**: Add event listener cleanup on component destroy
...
- [x] **Task 5**: Test dropdown functionality
...
- [x] **Task 6**: Run lint and typecheck
  - `uv run ruff check .`
  - `uv run pyright`
  - Estimated: 10 min
