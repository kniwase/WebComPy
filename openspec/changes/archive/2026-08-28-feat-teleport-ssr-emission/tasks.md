...
- [x] 7.2 Update AGENTS.md Framework Invariants list and `.opencode/skills/webcompy-review/SKILL.md` critical-invariants headings referencing teleport/hydration/elements specs
- [x] 7.3 Run `python3 scripts/check-doc-spec-refs.py` and fix dangling references (e.g. "anchor-only" phrasing in universal docs)
