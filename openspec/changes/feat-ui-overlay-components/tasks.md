...
- [x] 6.3 Dropdown: trigger ARIA state across toggle, keyboard navigation (arrows wrap, Home/End, Escape returns focus, Enter activates+closes), outside-click close with trigger exclusion, listener cleanup
