...
- [x] 8.3 E2E: verify (a) pre-rendered HTML from `<user-card>` component tag matches expected structure, (b) hydration reuses existing component DOM nodes, (c) reactive prop changes (`:count="signal"`) propagate to the child component after hydration
