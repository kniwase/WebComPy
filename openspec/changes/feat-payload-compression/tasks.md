...
- [x] 1.2 After JSON serialization and HTML escaping, check if the byte length exceeds `compression_threshold`
...
- [x] 6.4 Run `scripts/run-e2e-tests.sh` — verify hydration data transfer works with compression enabled
- [x] 6.5 `npx @fission-ai/openspec@latest validate` passes
