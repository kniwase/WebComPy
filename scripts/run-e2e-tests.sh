...
declare -A E2E_GROUPS=(
  ...
  ["template"]="e2e/core/test_template.py e2e/core/test_template_components.py e2e/core/test_template_control_flow.py e2e/core/test_markdown_for.py e2e/core/test_html_parser_parity.py"
)
