...
declare -A E2E_GROUPS=(
  ...
  ["interaction"]="e2e/core/test_event.py e2e/core/test_event_source.py e2e/core/test_event_source_post.py e2e/core/test_websocket.py e2e/core/test_rpc_ws.py e2e/core/test_di.py e2e/core/test_two_way_binding.py e2e/core/test_form_fields.py e2e/core/test_storage.py e2e/core/test_storage_tab_sync.py e2e/core/test_readonly_signal.py"
