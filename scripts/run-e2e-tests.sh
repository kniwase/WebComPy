...
declare -A E2E_GROUPS=(
  ["bootstrap-static"]="e2e/core/test_bootstrap.py e2e/core/test_static_site.py e2e/core/test_signal_value_transfer.py e2e/core/test_loading_screen.py"
  ...
  ["interaction"]="e2e/core/test_event.py e2e/core/test_event_source.py e2e/core/test_websocket.py e2e/core/test_rpc_ws.py e2e/core/test_di.py e2e/core/test_two_way_binding.py e2e/core/test_form_fields.py e2e/core/test_storage.py e2e/core/test_storage_tab_sync.py e2e/core/test_readonly_signal.py"
...
declare -A DOCS_GROUPS=(
  ...
  ["docs-documents"]="e2e/docs/test_documents.py e2e/docs/test_hydration_preservation.py e2e/docs/test_installation.py e2e/docs/test_quickstart.py e2e/docs/test_signal_stream.py e2e/docs/test_readonly_signal.py e2e/docs/test_event_source.py e2e/docs/test_websocket.py e2e/docs/test_typed_realtime.py e2e/docs/test_rpc_websocket.py e2e/docs/test_resource_transfer.py"
