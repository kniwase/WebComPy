...
declare -A E2E_GROUPS=(
  ...
  ["router"]="e2e/core/test_router.py e2e/core/test_async_nav.py e2e/core/test_nested_routes.py e2e/core/test_scroll_restoration.py"
  ["interaction"]="e2e/core/test_event.py e2e/core/test_di.py e2e/core/test_two_way_binding.py e2e/core/test_form_fields.py e2e/core/test_storage.py"
