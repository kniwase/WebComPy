...
| `webcompy/_browser/` | `browser-api/spec.md` |
| `webcompy/ports/` | `port-abstraction/spec.md` |
| `webcompy/ports/_server/` | `virtual-dom/spec.md` |
...
| `webcompy/cli/` | `cli/spec.md`, `project-config/spec.md`, `config-separation/spec.md`, `inspect-cli/spec.md` |
| `webcompy/testing/` | `testing-module/spec.md` |
