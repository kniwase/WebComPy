...
- All OpenCode agents are defined under `.opencode/agents/*.md` with frontmatter metadata. Agents migrated from `opencode.json` include: `browser-runtime`, `server-runtime`, `webcompy-docs`.
